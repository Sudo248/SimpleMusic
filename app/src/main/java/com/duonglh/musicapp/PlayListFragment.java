 ...
 */
public class PlayListFragment extends Fragment implements MyInterface.ResponseSearch{
    ...
    private void deleteSong(int position){
        ...
        mainActivity.removeSongInService(position);
        songAdapter.notifyDataSetChanged();
        Toast.makeText(mainContext,"Delete "+ song.getNameSong() + " success",Toast.LENGTH_LONG).show();
